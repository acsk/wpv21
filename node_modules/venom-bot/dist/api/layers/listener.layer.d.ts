...
export declare class ListenerLayer extends ProfileLayer {
     ...
     */
    onMessage(fn: (message: Message) => void): Promise<void>;
    /**
     ...
     * @returns Observable stream of messages
     */
    onStateChange(fn: (state: SocketState) => void): Promise<void>;
    /**
     * @event Listens to messages acknowledgement Changes
     * @returns Observable stream of messages
     */
    onAck(fn: (ack: Ack) => void): Promise<void>;
    /**
     ...
     * @returns Observable stream of messages
     */
    onIncomingCall(fn: (call: any) => any): Promise<void>;
}
