            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.page.exposeFunction(exposed_enum_1.ExposedFn.OnMessage, function (message) {
                                return fn(message);
                            })];
                    case 2:
                        _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.page
                                .exposeFunction(exposed_enum_1.ExposedFn.OnAnyMessage, function (message) {
                                return fn(message);
                            })
                                .then(function (_) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        has = _a.sent();
                        if (!!has) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.page.exposeFunction(exposed_enum_1.ExposedFn.onAck, function (ack) { return fn(ack); })];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [2 /*return*/];
    ...
    ListenerLayer.prototype.onIncomingCall = function (fn) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.page
                        .exposeFunction(method, function (call) { return fn(call); })
                        .then(function (_) {
                        return _this.page.evaluate(function () {
                            //@ts-ignore
