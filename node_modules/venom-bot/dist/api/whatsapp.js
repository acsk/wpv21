...
var Whatsapp = /** @class */ (function (_super) {
    ...
    Whatsapp.prototype.decryptFile = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var options, clientUrl, haventGottenImageYet, res, error_2, buff;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options = decrypt_1.makeOptions(WAuserAgente_1.useragentOverride), clientUrl = message.deprecatedMms3Url;
                        if (!clientUrl) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, axios_1.default.get(message.deprecatedMms3Url.trim(), options)];
                    case 3:
                        res = _a.sent();
