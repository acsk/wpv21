...
exports.auth_InjectToken = exports.SessionTokenCkeck = exports.retrieveQR = exports.asciiQr = exports.isInsideChat = exports.needsToScan = exports.isAuthenticated = void 0;
/*
...
var isAuthenticated = function (waPage) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            return [2 /*return*/, rxjs_1.merge(exports.needsToScan(waPage), exports.isInsideChat(waPage))
...
function auth_InjectToken(page, session, options, token) {
    return __awaiter(this, void 0, void 0, function () {
        var jsonToken, pathToken;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(typeof token === 'object')) return [3 /*break*/, 2];
                    jsonToken = token;
                ...
                case 2:
                    ...
                    if (!fs_1.existsSync(pathToken)) return [3 /*break*/, 5];
                    jsonToken = JSON.parse(fs_1.readFileSync(pathToken).toString());
                    if (!!jsonToken) return [3 /*break*/, 3];
                    return [2 /*return*/, false];
                case 3: return [4 /*yield*/, page.evaluateOnNewDocument(function (session) {
                        localStorage.clear();
                        Object.keys(session).forEach(function (key) {
                            localStorage.setItem(key, session[key]);
                        });
