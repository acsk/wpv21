...
var ListenerLayer = /** @class */ (function (_super) {
    ...
    ListenerLayer.prototype.onAnyMessage = function (fn) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.listenerEmitter.on(exposed_enum_1.ExposedFn.OnAnyMessage, function (state) {
                    fn(state);
                });
                return [2 /*return*/, {
                        dispose: function () {
    ...
    ListenerLayer.prototype.onStateChange = function (fn) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.listenerEmitter.on(exposed_enum_1.ExposedFn.onStateChange, function (state) {
                    fn(state);
                });
                return [2 /*return*/, {
                        dispose: function () {
    ...
    ListenerLayer.prototype.onAck = function (fn) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.listenerEmitter.on(exposed_enum_1.ExposedFn.onAck, function (state) {
                    fn(state);
                });
                return [2 /*return*/, {
                        dispose: function () {
    ...
    ListenerLayer.prototype.onAddedToGroup = function (fn) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.listenerEmitter.on('onAddedToGroup', function (state) {
                    fn(state);
                });
                return [2 /*return*/, {
                        dispose: function () {
    ...
    ListenerLayer.prototype.onIncomingCall = function (fn) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.listenerEmitter.on('onIncomingCall', function (state) {
                    fn(state);
                });
                return [2 /*return*/, {
                        dispose: function () {
