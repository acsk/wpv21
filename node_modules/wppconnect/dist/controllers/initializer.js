...
function create(sessionOrOption, catchQR, statusFind, options, browserSessionToken) {
    return __awaiter(this, void 0, void 0, function () {
        var session, browserToken, mergedOptions, logger, browser, waPage_1, client_1, LocalLogin, _a, _b, CheckLogin, isLogged, waitLoginPromise_1, debugURL;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, browser_1.initBrowser(session, mergedOptions).catch(function (e) {
                ...
                case 3:
                    browser = _c.sent();
                    if (!(typeof browser === 'object')) return [3 /*break*/, 8];
                            ...
                            if (state === enum_1.SocketState.CONNECTED) {
                                setTimeout(function () {
                                    auth_1.saveToken(waPage_1, session, mergedOptions).catch(function (e) {
                                        logger.error(e, { session: session });
                                    });
                                }, 1000);
                            }
                        });
                ...
                case 5:
                    LocalLogin = _b.apply(_a, [_c.sent()]);
                    CheckLogin = LocalLogin.WASecretBundle && LocalLogin.WAToken1 && LocalLogin.WAToken2
                        ? true
                        : false;
                    if (!!CheckLogin) return [3 /*break*/, 7];
                    if (!mergedOptions.waitForLogin) return [3 /*break*/, 7];
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    logger.info('Session Unpaired', { session: session });
                                    if (statusFind) {
                                        statusFind('desconnectedMobile', session);
                                    }
                                    helpers_1.deleteFiles(mergedOptions, session, logger);
