        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, latest_version_1.default('@wppconnect-team/wppconnect').then(function (latest) {
...
function logUpdateAvailable(current, latest) {
    // prettier-ignore
    var newVersionLog = "There is a new version of " + chalk.bold("Wppconnect") + " " + chalk.gray(current) + " \u279C  " + chalk.bold.green(latest) + "\n" +
        "Update your package by running:\n\n" +
        (chalk.bold('\>') + " " + chalk.blueBright('npm update wppconnect'));
    logger_1.defaultLogger.info(boxen(newVersionLog, { padding: 1 }));
    logger_1.defaultLogger.info("For more info visit: " + chalk.underline('https://github.com/wppconnect-team/wppconnect/blob/master/Update.md') + "\n");
}
